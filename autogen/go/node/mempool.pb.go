...
func (x *GetUnconfirmedBalanceRequest) Reset() {
	*x = GetUnconfirmedBalanceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUnconfirmedBalanceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUnconfirmedBalanceRequest) ProtoMessage() {}

func (x *GetUnconfirmedBalanceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mempool_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
var file_mempool_proto_rawDesc = []byte{
	...
	,
...
func file_mempool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mempool_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUnconfirmedBalanceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
