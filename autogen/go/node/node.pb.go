...
var file_node_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x32, 0x51, 0x0a, 0x0a, 0x4d, 0x61, 0x69, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12,
	0x43, 0x0a, 0x14, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x65,
	0x6e, 0x73, 0x75, 0x73, 0x54, 0x78, 0x73, 0x12, 0x12, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x6e, 0x6f,
	0x64, 0x65, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x2f, 0x61, 0x75, 0x74, 0x6f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x6e, 0x6f, 0x64, 0x65,
...
var file_node_proto_depIdxs = []int32{
	...
	0,  // 16: node.Maintainer.AutomateConsensusTxs:input_type -> node.EmptyRequest
	9,  // 17: node.Wallet.CreateWallet:output_type -> node.LoadResponse
	9,  // 18: node.Wallet.LoadWallet:output_type -> node.LoadResponse
	9,  // 19: node.Wallet.CreateFromSeed:output_type -> node.LoadResponse
	1,  // 20: node.Wallet.ClearWalletDatabase:output_type -> node.GenericResponse
	10, // 21: node.Wallet.GetWalletStatus:output_type -> node.WalletStatusResponse
	9,  // 22: node.Wallet.GetAddress:output_type -> node.LoadResponse
	11, // 23: node.Wallet.GetBalance:output_type -> node.BalanceResponse
	12, // 24: node.Wallet.GetTxHistory:output_type -> node.TxHistoryResponse
	11, // 25: node.Mempool.GetUnconfirmedBalance:output_type -> node.BalanceResponse
	13, // 26: node.Mempool.SelectTx:output_type -> node.SelectResponse
	1,  // 27: node.Chain.RebuildChain:output_type -> node.GenericResponse
	14, // 28: node.Chain.GetSyncProgress:output_type -> node.SyncProgressResponse
	15, // 29: node.Transactor.CallContract:output_type -> node.TransactionResponse
	15, // 30: node.Transactor.Transfer:output_type -> node.TransactionResponse
	15, // 31: node.Transactor.Bid:output_type -> node.TransactionResponse
	15, // 32: node.Transactor.Stake:output_type -> node.TransactionResponse
	1,  // 33: node.Maintainer.AutomateConsensusTxs:output_type -> node.GenericResponse
...
func (*UnimplementedMaintainerServer) AutomateConsensusTxs(context.Context, *EmptyRequest) (*GenericResponse, error) {
